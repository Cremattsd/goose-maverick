...
CMD ["sh", "-c", "redis-server --daemonize yes && gunicorn --bind 0.0.0.0:$PORT --workers 4 --threads 8 --timeout 120 --log-level info app:app"]# Use a lightweight Python 3.11 base image
FROM python:3.11-slim
